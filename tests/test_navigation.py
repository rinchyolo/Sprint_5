...
class TestNavigation:
    ...
    def test_constructor_navigation_tabs(self, driver):
        ...
        assert driver.find_element(*TestLocators.INGREDIENT_SAUCES).is_displayed()
        ...
        assert driver.find_element(*TestLocators.INGREDIENT_FILLING).is_displayed()
        ...
        assert driver.find_element(*TestLocators.INGREDIENT_BUNS).is_displayed()
